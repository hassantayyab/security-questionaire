    ...
    <div className='max-w-7xl mx-auto space-y-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
        ...
        <Card className='text-center'>
          ...
          <CardContent>
            <CardDescription>
              Upload Excel questionnaires and let AI generate accurate answers based on your
              policies
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className='text-center'>
          ...
          <CardContent>
            <CardDescription>
              Review, edit, and approve AI-generated answers before exporting your completed
              questionnaire
            </CardDescription>
          </CardContent>
        </Card>
