  ...
  const renderAnswerWithSource = (question: Question): ReactNode => {
      ...
      return (
        <div className='flex items-center gap-2 group'>
          <div className='flex items-center gap-1.5 flex-1 min-w-0'>
            <SimpleTooltip content='Generated by Secfix Agent'>
              <Sparkles className='w-3.5 h-3.5 text-violet-600 flex-shrink-0' />
            </SimpleTooltip>
            <SimpleTooltip content={question.answer || ''}>
    ...
    if (answerSource === 'user') {
      ...
      return (
        <div className='flex items-center gap-2 group'>
          <div className='flex items-center gap-1.5 flex-1 min-w-0'>
            <SimpleTooltip content='Added by user'>
    ...
    if (answerSource === 'copied') {
      ...
      return (
        <div className='flex items-center gap-2 group'>
          <div className='flex items-center gap-1.5 flex-1 min-w-0'>
            <SimpleTooltip content='Copied from previous questionnaire'>
  ...
  const columns: TableColumn<Question>[] = [
    {
      ...
      render: (question) => (
        <SimpleTooltip content={question.question_text}>
  ...
  const inlineActions: TableInlineAction<Question>[] = [
    {
      key: 'approve',
      icon: (
        <SimpleTooltip content='Approve answer'>
          <Check className='w-4 h-4 text-gray-600' />
        </SimpleTooltip>
      ),
      onClick: onApprove,
    ...
    },
    {
      key: 'unapprove',
      icon: (
        <SimpleTooltip content='Unapprove answer'>
